...
namespace Logger.Controllers
{
    ...
    public class LogsController : ControllerBase
    {
        ...
        [HttpGet("games")]
        public async Task<IActionResult> GetGamesLogsAsync([FromQuery] dynamic searchCriteria)
        {
        ...
        [HttpGet("users")]
        public async Task<IActionResult> GetUsersLogsAsync([FromQuery] dynamic searchCriteria)
        {
